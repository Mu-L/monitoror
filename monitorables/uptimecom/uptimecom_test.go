...
func TestNewMonitorable(t *testing.T) {
	...
	// init Env
	// OK
	_ = os.Setenv("MO_MONITORABLE_UPTIMECOM_VARIANT0_TOKEN", "xxx")
	// Missing Token
	_ = os.Setenv("MO_MONITORABLE_UPTIMECOM_VARIANT1_URL", "https://uptimecom.example.com")
	// Url broken
	_ = os.Setenv("MO_MONITORABLE_UPTIMECOM_VARIANT2_URL", "url%suptimecom.example.com")
